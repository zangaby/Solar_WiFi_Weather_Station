...
char bserver[] = "192.xxx.xxx.xxx";  // IP for your Local Server
int port = 8080;

char ssid[] = "xxx";                           // WiFi Router ssid
char pass[] = "xxx";             // WiFi Router password

unsigned long ts_ch_id = xxx;                  // Thingspeak Channel ID
const char* ts_api_key = "xxx";      // API write key 
...
// NTP
#define NTP_SERVER      "de.pool.ntp.org"  // Swiss NTP pool - use any in your country
